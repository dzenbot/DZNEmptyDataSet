...
- (NSAttributedString *)descriptionForEmptyDataSet:(UIScrollView *)scrollView {
    ...
    NSString *text = @"Add a new bug or reopen a bug from the Closed tab.";
...
- (NSAttributedString *)buttonTitleForEmptyDataSet:(UIScrollView *)scrollView forState:(UIControlState)state
{
    NSDictionary *attributes = @{NSFontAttributeName: [UIFont boldSystemFontOfSize:[UIFont buttonFontSize]],
								 NSForegroundColorAttributeName: [UIColor colorWithHex:(state == UIControlStateNormal) ? @"05adff" : @"6bceff"]};
    
    return [[NSAttributedString alloc] initWithString:@"Add Bug" attributes:attributes];
}
